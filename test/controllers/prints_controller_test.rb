...
class PrintsControllerTest < ActionController::TestCase
  ...
  test "should create print" do
    assert_difference('Print.count') do
      post :create, print: { bottom: @print.bottom, left: @print.left, left: @print.left, right: @print.right, top: @print.top }
    end
  ...
  test "should update print" do
    patch :update, id: @print, print: { bottom: @print.bottom, left: @print.left, left: @print.left, right: @print.right, top: @print.top }
    assert_redirected_to print_path(assigns(:print))
  end
